...
#,RaceHorse.IsValidTimeSdvByRace=as.logical(RaceHorse.IsValidTimeSdvByRace)
...
#,RaceHorse.IsValidTimeSdvByJyoType1=as.logical(RaceHorse.IsValidTimeSdvByJyoType1)
...
#,RaceHorse.IsValidTimeSdvByRaceType0=as.logical(RaceHorse.IsValidTimeSdvByRaceType0)
...
#,RaceHorse.IsValidTimeSdvByRaceType1=as.logical(RaceHorse.IsValidTimeSdvByRaceType1)
...
#,RaceHorse.IsValidLastTimeSdv=as.logical(RaceHorse.IsValidLastTimeSdv)
...
#,RaceHorse.IsValidLastTimeSdvByRace=as.logical(RaceHorse.IsValidLastTimeSdvByRace)
...
#,RaceHorse.IsValidLastTimeSdvByJyoType1=as.logical(RaceHorse.IsValidLastTimeSdvByJyoType1)
...
#,RaceHorse.IsValidLastTimeSdvByRaceType0=as.logical(RaceHorse.IsValidLastTimeSdvByRaceType0)
...
#,RaceHorse.IsValidLastTimeSdvByRaceType1=as.logical(RaceHorse.IsValidLastTimeSdvByRaceType1)
...
#,RaceHorse.IsValidSpeedSdvByRace=as.logical(RaceHorse.IsValidSpeedSdvByRace)
...
#,RaceHorse.IsValidSpeedSdvByJyoType1=as.logical(RaceHorse.IsValidSpeedSdvByJyoType1)
...
#,RaceHorse.IsValidSpeedSdvByRaceType0=as.logical(RaceHorse.IsValidSpeedSdvByRaceType0)
...
#,RaceHorse.IsValidSpeedSdvByRaceType1=as.logical(RaceHorse.IsValidSpeedSdvByRaceType1)
...
#,RaceHorse.IsValidLastSpeedSdvByRace=as.logical(RaceHorse.IsValidLastSpeedSdvByRace)
...
#,RaceHorse.IsValidLastSpeedSdvByJyoType1=as.logical(RaceHorse.IsValidLastSpeedSdvByJyoType1)
...
#,RaceHorse.IsValidLastSpeedSdvByRaceType0=as.logical(RaceHorse.IsValidLastSpeedSdvByRaceType0)
...
#,RaceHorse.IsValidLastSpeedSdvByRaceType1=as.logical(RaceHorse.IsValidLastSpeedSdvByRaceType1)
...
,RaceHorse.IsHitA=as.logical(RaceHorse.IsHitA)
,RaceHorse.IsHitB=as.logical(RaceHorse.IsHitB)
,RaceHorse.IsHitC=as.logical(RaceHorse.IsHitC)
,RaceHorse.IsHitD=as.logical(RaceHorse.IsHitD)
,RaceHorse.IsHitE=as.logical(RaceHorse.IsHitE)
...
# ,Gen01.RunCount=as.numeric(Gen01.RunCount)
# ,Gen01.HitCountA=as.numeric(Gen01.HitCountA)
# ,Gen01.HitRateA=as.numeric(Gen01.HitRateA)
# ,Gen01.TimeDvAvg=as.numeric(Gen01.TimeDvAvg)
# ,Gen01.LastTimeDvAvg=as.numeric(Gen01.LastTimeDvAvg)
# ,Gen01.SpeedDvAvg=as.numeric(Gen01.SpeedDvAvg)
# ,Gen01.LastSpeedDvAvg=as.numeric(Gen01.LastSpeedDvAvg)
# ,Gen01.TimeDvMax=as.numeric(Gen01.TimeDvMax)
# ,Gen01.LastTimeDvMax=as.numeric(Gen01.LastTimeDvMax)
# ,Gen01.SpeedDvMax=as.numeric(Gen01.SpeedDvMax)
# ,Gen01.LastSpeedDvMax=as.numeric(Gen01.LastSpeedDvMax)
# ,Gen01.TimeDvMin=as.numeric(Gen01.TimeDvMin)
# ,Gen01.LastTimeDvMin=as.numeric(Gen01.LastTimeDvMin)
# ,Gen01.SpeedDvMin=as.numeric(Gen01.SpeedDvMin)
# ,Gen01.LastSpeedDvMin=as.numeric(Gen01.LastSpeedDvMin)

# ,Gen02.RunCount=as.numeric(Gen02.RunCount)
# ,Gen02.HitCountA=as.numeric(Gen02.HitCountA)
# ,Gen02.HitRateA=as.numeric(Gen02.HitRateA)
# ,Gen02.TimeDvAvg=as.numeric(Gen02.TimeDvAvg)
# ,Gen02.LastTimeDvAvg=as.numeric(Gen02.LastTimeDvAvg)
# ,Gen02.SpeedDvAvg=as.numeric(Gen02.SpeedDvAvg)
# ,Gen02.LastSpeedDvAvg=as.numeric(Gen02.LastSpeedDvAvg)
# ,Gen02.TimeDvMax=as.numeric(Gen02.TimeDvMax)
# ,Gen02.LastTimeDvMax=as.numeric(Gen02.LastTimeDvMax)
# ,Gen02.SpeedDvMax=as.numeric(Gen02.SpeedDvMax)
# ,Gen02.LastSpeedDvMax=as.numeric(Gen02.LastSpeedDvMax)
# ,Gen02.TimeDvMin=as.numeric(Gen02.TimeDvMin)
# ,Gen02.LastTimeDvMin=as.numeric(Gen02.LastTimeDvMin)
# ,Gen02.SpeedDvMin=as.numeric(Gen02.SpeedDvMin)
# ,Gen02.LastSpeedDvMin=as.numeric(Gen02.LastSpeedDvMin)

,Gen05.RunCount=as.numeric(Gen05.RunCount)
,Gen05.HitCountA=as.numeric(Gen05.HitCountA)
,Gen05.HitRateA=as.numeric(Gen05.HitRateA)
,Gen05.TimeDvAvg=as.numeric(Gen05.TimeDvAvg)
,Gen05.LastTimeDvAvg=as.numeric(Gen05.LastTimeDvAvg)
,Gen05.SpeedDvAvg=as.numeric(Gen05.SpeedDvAvg)
,Gen05.LastSpeedDvAvg=as.numeric(Gen05.LastSpeedDvAvg)
,Gen05.TimeDvMax=as.numeric(Gen05.TimeDvMax)
,Gen05.LastTimeDvMax=as.numeric(Gen05.LastTimeDvMax)
,Gen05.SpeedDvMax=as.numeric(Gen05.SpeedDvMax)
,Gen05.LastSpeedDvMax=as.numeric(Gen05.LastSpeedDvMax)
,Gen05.TimeDvMin=as.numeric(Gen05.TimeDvMin)
,Gen05.LastTimeDvMin=as.numeric(Gen05.LastTimeDvMin)
,Gen05.SpeedDvMin=as.numeric(Gen05.SpeedDvMin)
,Gen05.LastSpeedDvMin=as.numeric(Gen05.LastSpeedDvMin)
