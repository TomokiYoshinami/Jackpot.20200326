...
AnalyzeExpectedValue01Gen02.ExpectedValue

~

+ 1

+ AnalyzeExpectedValue01Gen02.PrevExpectedValue + (AnalyzeExpectedValue01Gen02.PrevExpectedValue|AnalyzeExpectedValue01Gen02.PrevHansyokuNum)
+ AnalyzeExpectedValue01Gen02.PrevHitRateA + (AnalyzeExpectedValue01Gen02.PrevHitRateA|AnalyzeExpectedValue01Gen02.PrevHansyokuNum)
