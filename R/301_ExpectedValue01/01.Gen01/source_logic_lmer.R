...
AnalyzeExpectedValue01Gen01.ExpectedValue

~

+ 1

+ AnalyzeExpectedValue01Gen01.PrevExpectedValue + (AnalyzeExpectedValue01Gen01.PrevExpectedValue|AnalyzeExpectedValue01Gen01.PrevHansyokuNum)
+ AnalyzeExpectedValue01Gen01.PrevHitRateA + (AnalyzeExpectedValue01Gen01.PrevHitRateA|AnalyzeExpectedValue01Gen01.PrevHansyokuNum)
