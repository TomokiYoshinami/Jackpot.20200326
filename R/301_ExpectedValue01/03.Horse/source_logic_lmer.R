...
AnalyzeExpectedValue01Horse.ExpectedValue

~

+ 1

+ AnalyzeExpectedValue01Horse.PrevExpectedValue + (AnalyzeExpectedValue01Horse.PrevExpectedValue|AnalyzeExpectedValue01Horse.PrevKettoNum)
+ AnalyzeExpectedValue01Horse.PrevHitRateA + (AnalyzeExpectedValue01Horse.PrevHitRateA|AnalyzeExpectedValue01Horse.PrevKettoNum)
