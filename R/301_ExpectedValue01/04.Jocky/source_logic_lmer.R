...
AnalyzeExpectedValue01Jocky.ExpectedValue

~

+ 1

+ AnalyzeExpectedValue01Jocky.PrevExpectedValue + (AnalyzeExpectedValue01Jocky.PrevExpectedValue|AnalyzeExpectedValue01Jocky.PrevKisyuCode)
+ AnalyzeExpectedValue01Jocky.PrevHitRateA + (AnalyzeExpectedValue01Jocky.PrevHitRateA|AnalyzeExpectedValue01Jocky.PrevKisyuCode)
