...
hist(data$Horse.TimeDvByRaceAvg, main = "TimeDvByRaceAvg", breaks = "scott", col = "orange")
hist(data$Horse.TimeDvByRaceMin, main = "TimeDvByRaceMin", breaks = "scott", col = "orange")
hist(data$Horse.TimeDvByRaceMax, main = "TimeDvByRaceMax", breaks = "scott", col = "orange")
hist(data$Horse.RunCount, main = "RunCount", breaks = "scott", col = "orange")
hist(data$Horse.HitCount1, main = "HitCount1", breaks = "scott", col = "orange")
hist(data$Horse.HitCount2, main = "HitCount2", breaks = "scott", col = "orange")
hist(data$Horse.HitCount3, main = "HitCount3", breaks = "scott", col = "orange")
hist(data$Horse.HitCount4, main = "HitCount4", breaks = "scott", col = "orange")
hist(data$Horse.HitCount5, main = "HitCount5", breaks = "scott", col = "orange")
hist(data$Horse.HitRate1, main = "HitRate1", breaks = "scott", col = "orange")
hist(data$Horse.HitRate2, main = "HitRate2", breaks = "scott", col = "orange")
hist(data$Horse.HitRate3, main = "HitRate3", breaks = "scott", col = "orange")
hist(data$Horse.HitRate4, main = "HitRate4", breaks = "scott", col = "orange")
hist(data$Horse.HitRate5, main = "HitRate5", breaks = "scott", col = "orange")
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Horse.TimeDvByRaceAvg"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Horse.TimeDvByRaceAvg, main = "Horse.TimeDvByRaceAvg", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceAvg | Race.JyokenCd, main = "Horse.TimeDvByRaceAvg by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceAvg | Race.RaceType1Cd, main = "Horse.TimeDvByRaceAvg by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Horse.TimeDvByRaceMin"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Horse.TimeDvByRaceMin, main = "Horse.TimeDvByRaceMin", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceMin | Race.JyokenCd, main = "Horse.TimeDvByRaceMin by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceMin | Race.RaceType1Cd, main = "Horse.TimeDvByRaceMin by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Horse.TimeDvByRaceMax"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Horse.TimeDvByRaceMax, main = "Horse.TimeDvByRaceMax", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceMax | Race.JyokenCd, main = "Horse.TimeDvByRaceMax by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Horse.TimeDvByRaceMax | Race.RaceType1Cd, main = "Horse.TimeDvByRaceMax by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.TimeDvByRaceAvg vs Horse.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.TimeDvByRace ~ Horse.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.TimeDvByRace vs Horse.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.IsHitA vs Horse.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.IsHitA ~ Horse.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.IsHitA vs Horse.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
