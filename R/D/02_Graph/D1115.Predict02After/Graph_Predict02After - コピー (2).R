...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Time.FinishTime"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Time.FirstTime"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Time.LastTime"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepHorseNumRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepWeight"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepWeightDelta"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepWeightDeltaRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepHandicap"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepHandicapRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Prep.PrepLifetime"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.HorseNumRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.WeightSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
hist(data$RaceHorse.WeightSdv, main = "RaceHorse.WeightSdv", breaks = "scott", col = "orange")
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.WeightDeltaSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.WeightDeltaRatioSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
hist(data$RaceHorse.WeightDeltaRatioSdv, main = "RaceHorse.WeightDeltaRatioSdv", breaks = "scott", col = "orange")
hist(data$RaceHorse.WeightDeltaRatioSdvSdvByRace, main = "RaceHorse.WeightDeltaRatioSdvSdvByRace", breaks = "scott", col = "orange")
hist(data$RaceHorse.WeightDeltaRatioSdvSdv, main = "RaceHorse.WeightDeltaRatioSdvSdv", breaks = "scott", col = "orange")
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# hist
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.HandicapSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
hist(data$RaceHorse.HandicapSdv, main = "RaceHorse.HandicapRatioSdv", breaks = "scott", col = "orange")
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.HandicapRatioSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Basic.LifetimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "hist.RaceHorse.Predict.PredictValueA"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
hist(data$RaceHorse.PredictValueA, main = "RaceHorse.PredictValueA", breaks = "scott", col = "orange")
hist(log(data$RaceHorse.PredictValueA), main = "RaceHorse.PredictValueA(Log)", breaks = "scott", col = "orange")
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# hist
...
hist(log(data$OddsByWin.Odds1), main = "OddsByWin.Odds1(Log)", breaks = "scott", col = "orange")
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.Odds1"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOdds1"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOdds1, main = "OddsByWin.RealOdds1", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.OddsLog1 by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.OddsLog1 by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.OddsLog1 by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOddsLog1 by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOddsLog1 | Race.TrackTypeCd, main = "OddsByWin.RealOddsLog1 by Race.TrackTypeCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOddsLog1 by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOddsLog1 | Race.JyokenCd, main = "OddsByWin.RealOddsLog1 by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOddsLog1 by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOddsLog1 | Race.JyoCd, main = "OddsByWin.RealOddsLog1 by Race.JyoCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOddsLog1 by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOddsLog1 | Race.JyoType1Cd, main = "OddsByWin.RealOddsLog1 by Race.JyoType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.OddsByWin.RealOddsLog1 by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
histogram(~ OddsByWin.RealOddsLog1 | Race.RaceType1Cd, main = "OddsByWin.RealOddsLog1 by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
# -------------------------------------------------------------------------------------------------------
# histogram
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdvByRace by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdvByRace by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdvByRace by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.RaceHorse.Time.FinishTimeSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HorseNumRatio by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.WeightDeltaSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.HandicapRatioSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs RaceHorse.LifetimeSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs PredictByWin.PredictValue by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMining.DmTimeSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs DataMiningTaisen.TmScoreSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1 by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1 by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1 by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1 by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdv vs OddsByWin.OddsLog1 by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HorseNumRatio by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.WeightDeltaSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.HandicapRatioSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs RaceHorse.LifetimeSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs PredictByWin.PredictValue by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMining.DmTimeSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs DataMiningTaisen.TmScoreSdv by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1 by Race.TrackTypeCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1 by Race.JyokenCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1 by Race.JyoCd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1 by Race.JyoType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "xyplot.RaceHorse.Time.FinishTimeSdvByRace vs OddsByWin.OddsLog1 by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
