...
graphVersion <- "D1116"
graphCategory <- "Graph"
graphType <- "AnalyzeD1116Step02Jockey"
graphTrackTypeCd <- 0
graphJyokenCd <- "0"
# -------------------------------------------------------------------------------------------------------
# Declaration
...
sqlQuery <- paste0("SELECT PredictValueA, PredictValueLogitA FROM AnalyzeD1116Step02Jockey")
...
# -------------------------------------------------------------------------------------------------------
# tic()
graphName <- "histogram.AnalyzeD1116Step02Jockey"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", graphCategory, "_", graphType, "_", graphName), constFileExtensionPdf, sep = constColon)
print(paste0("pdfFilename=", pdfFilename))
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9)
