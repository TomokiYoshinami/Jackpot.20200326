...
hist(data$Gen02.TimeDvByRaceAvg, main = "TimeDvByRaceAvg", breaks = "scott", col = "orange")
hist(data$Gen02.TimeDvByRaceMin, main = "TimeDvByRaceMin", breaks = "scott", col = "orange")
hist(data$Gen02.TimeDvByRaceMax, main = "TimeDvByRaceMax", breaks = "scott", col = "orange")
hist(data$Gen02.RunCount, main = "RunCount", breaks = "scott", col = "orange")
hist(data$Gen02.HitCount1, main = "HitCount1", breaks = "scott", col = "orange")
hist(data$Gen02.HitCount2, main = "HitCount2", breaks = "scott", col = "orange")
hist(data$Gen02.HitCount3, main = "HitCount3", breaks = "scott", col = "orange")
hist(data$Gen02.HitCount4, main = "HitCount4", breaks = "scott", col = "orange")
hist(data$Gen02.HitCount5, main = "HitCount5", breaks = "scott", col = "orange")
hist(data$Gen02.HitRate1, main = "HitRate1", breaks = "scott", col = "orange")
hist(data$Gen02.HitRate2, main = "HitRate2", breaks = "scott", col = "orange")
hist(data$Gen02.HitRate3, main = "HitRate3", breaks = "scott", col = "orange")
hist(data$Gen02.HitRate4, main = "HitRate4", breaks = "scott", col = "orange")
hist(data$Gen02.HitRate5, main = "HitRate5", breaks = "scott", col = "orange")
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen02.TimeDvByRaceAvg"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen02.TimeDvByRaceAvg, main = "Gen02.TimeDvByRaceAvg", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceAvg | Race.JyokenCd, main = "Gen02.TimeDvByRaceAvg by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceAvg | Race.RaceType1Cd, main = "Gen02.TimeDvByRaceAvg by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen02.TimeDvByRaceMin"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen02.TimeDvByRaceMin, main = "Gen02.TimeDvByRaceMin", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceMin | Race.JyokenCd, main = "Gen02.TimeDvByRaceMin by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceMin | Race.RaceType1Cd, main = "Gen02.TimeDvByRaceMin by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen02.TimeDvByRaceMax"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen02.TimeDvByRaceMax, main = "Gen02.TimeDvByRaceMax", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceMax | Race.JyokenCd, main = "Gen02.TimeDvByRaceMax by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen02.TimeDvByRaceMax | Race.RaceType1Cd, main = "Gen02.TimeDvByRaceMax by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.TimeDvByRaceAvg vs Gen02.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.TimeDvByRace ~ Gen02.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.TimeDvByRace vs Gen02.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.IsHitA vs Gen02.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.IsHitA ~ Gen02.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.IsHitA vs Gen02.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
