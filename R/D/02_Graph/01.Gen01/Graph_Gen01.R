...
hist(data$Gen01.TimeDvByRaceAvg, main = "TimeDvByRaceAvg", breaks = "scott", col = "orange")
hist(data$Gen01.TimeDvByRaceMin, main = "TimeDvByRaceMin", breaks = "scott", col = "orange")
hist(data$Gen01.TimeDvByRaceMax, main = "TimeDvByRaceMax", breaks = "scott", col = "orange")
hist(data$Gen01.RunCount, main = "RunCount", breaks = "scott", col = "orange")
hist(data$Gen01.HitCount1, main = "HitCount1", breaks = "scott", col = "orange")
hist(data$Gen01.HitCount2, main = "HitCount2", breaks = "scott", col = "orange")
hist(data$Gen01.HitCount3, main = "HitCount3", breaks = "scott", col = "orange")
hist(data$Gen01.HitCount4, main = "HitCount4", breaks = "scott", col = "orange")
hist(data$Gen01.HitCount5, main = "HitCount5", breaks = "scott", col = "orange")
hist(data$Gen01.HitRate1, main = "HitRate1", breaks = "scott", col = "orange")
hist(data$Gen01.HitRate2, main = "HitRate2", breaks = "scott", col = "orange")
hist(data$Gen01.HitRate3, main = "HitRate3", breaks = "scott", col = "orange")
hist(data$Gen01.HitRate4, main = "HitRate4", breaks = "scott", col = "orange")
hist(data$Gen01.HitRate5, main = "HitRate5", breaks = "scott", col = "orange")
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen01.TimeDvByRaceAvg"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen01.TimeDvByRaceAvg, main = "Gen01.TimeDvByRaceAvg", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceAvg | Race.JyokenCd, main = "Gen01.TimeDvByRaceAvg by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceAvg | Race.RaceType1Cd, main = "Gen01.TimeDvByRaceAvg by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen01.TimeDvByRaceMin"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen01.TimeDvByRaceMin, main = "Gen01.TimeDvByRaceMin", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceMin | Race.JyokenCd, main = "Gen01.TimeDvByRaceMin by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceMin | Race.RaceType1Cd, main = "Gen01.TimeDvByRaceMin by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "histogram.Gen01.TimeDvByRaceMax"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
histogram(~ Gen01.TimeDvByRaceMax, main = "Gen01.TimeDvByRaceMax", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceMax | Race.JyokenCd, main = "Gen01.TimeDvByRaceMax by Race.JyokenCd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
histogram(~ Gen01.TimeDvByRaceMax | Race.RaceType1Cd, main = "Gen01.TimeDvByRaceMax by Race.RaceType1Cd", data= data, labels = TRUE, type = histogramType, layout = histogramLayout)
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.TimeDvByRaceAvg vs Gen01.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.TimeDvByRace ~ Gen01.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.TimeDvByRace vs Gen01.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
graphType <- "xyplot.RaceHorse.IsHitA vs Gen01.TimeDvByRace by Race.RaceType1Cd"
pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_", graphType), constFileExtensionPdf, sep = constColon)
pdfFilename
pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
par(ps=9) # フォントサイズ
xyplot(RaceHorse.IsHitA ~ Gen01.TimeDvByRaceAvg | Race.RaceType1Cd, data=data, main = "RaceHorse.IsHitA vs Gen01.TimeDvByRaceAvg by Race.RaceType1Cd", col = "blue", layout = c(3, 2))
dev.off()
# toc()
