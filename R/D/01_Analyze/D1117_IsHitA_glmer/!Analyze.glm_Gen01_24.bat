...
REM ECHO ********** Type15 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1117 analyze Gen01 IsHitA glmer 1 5
REM ECHO ********** Type16 **********
...
ECHO ********** Type24 **********
Rscript --slave --vanilla --encoding=utf-8 script.R D1117 analyze Gen01 IsHitA glmer 2 4
REM ECHO ********** Type25 **********
