...
ECHO ********** Type31 **********
Rscript --slave --vanilla --encoding=utf-8 script.R D1114 analyze Odds IsHitA glm 3 1
ECHO ********** Type35 **********
Rscript --slave --vanilla --encoding=utf-8 script.R D1114 analyze Odds IsHitA glm 3 5
