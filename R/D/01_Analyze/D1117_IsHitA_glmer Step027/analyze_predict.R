...
# Arguments
# ---------------------------------------------------------------------------------------------------------------------------
# analyzeVersion <- "D1117"
# analyzeCategory <- "Predict"
# analyzeType <- "Basic"
# analyzeFunc <- "glmer"
...
# ---------------------------------------------------------------------------------------------------------------------------
# InputDataSet New Levels: RaceHorse.ChokyosiCode
# ---------------------------------------------------------------------------------------------------------------------------
# print(paste0("levels(data$RaceHorse.ChokyosiCode)=", levels(data$RaceHorse.ChokyosiCode)))
# print(paste0("levels(InputDataSet$RaceHorse.ChokyosiCode)=", levels(InputDataSet$RaceHorse.ChokyosiCode)))
# RaceHorse.ChokyosiCode.Index <- which(!(InputDataSet$RaceHorse.ChokyosiCode %in% levels(data$RaceHorse.ChokyosiCode)))
# print(paste0("length(RaceHorse.ChokyosiCode.Index)=", length(RaceHorse.ChokyosiCode.Index)))
# InputDataSet$RaceHorse.ChokyosiCode[RaceHorse.ChokyosiCode.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
# InputDataSet New Levels: RaceHorse.BanusiCode
# ---------------------------------------------------------------------------------------------------------------------------
# print(paste0("levels(data$RaceHorse.BanusiCode)=", levels(data$RaceHorse.BanusiCode)))
# print(paste0("levels(InputDataSet$RaceHorse.BanusiCode)=", levels(InputDataSet$RaceHorse.BanusiCode)))
# RaceHorse.BanusiCode.Index <- which(!(InputDataSet$RaceHorse.BanusiCode %in% levels(data$RaceHorse.BanusiCode)))
# print(paste0("length(RaceHorse.BanusiCode.Index)=", length(RaceHorse.BanusiCode.Index)))
# InputDataSet$RaceHorse.BanusiCode[RaceHorse.BanusiCode.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
# InputDataSet New Levels: RaceHorse.KisyuCode
# ---------------------------------------------------------------------------------------------------------------------------
print(paste0("levels(data$RaceHorse.KisyuCode)=", levels(data$RaceHorse.KisyuCode)))
print(paste0("levels(InputDataSet$RaceHorse.KisyuCode)=", levels(InputDataSet$RaceHorse.KisyuCode)))
RaceHorse.KisyuCode.Index <- which(!(InputDataSet$RaceHorse.KisyuCode %in% levels(data$RaceHorse.KisyuCode)))
print(paste0("length(RaceHorse.KisyuCode.Index)=", length(RaceHorse.KisyuCode.Index)))
InputDataSet$RaceHorse.KisyuCode[RaceHorse.KisyuCode.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
...
# InputDataSet$RaceHorse.IsHitA[RaceHorse.IsHitA.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
# InputDataSet New Levels: Horse.Ketto3InfoHansyokuNum1
# ---------------------------------------------------------------------------------------------------------------------------
print(paste0("levels(data$Horse.Ketto3InfoHansyokuNum1)=", levels(data$Horse.Ketto3InfoHansyokuNum1)))
print(paste0("levels(InputDataSet$Horse.Ketto3InfoHansyokuNum1)=", levels(InputDataSet$Horse.Ketto3InfoHansyokuNum1)))
Horse.Ketto3InfoHansyokuNum1.Index <- which(!(InputDataSet$Horse.Ketto3InfoHansyokuNum1 %in% levels(data$Horse.Ketto3InfoHansyokuNum1)))
print(paste0("length(Horse.Ketto3InfoHansyokuNum1.Index)=", length(Horse.Ketto3InfoHansyokuNum1.Index)))
InputDataSet$Horse.Ketto3InfoHansyokuNum1[Horse.Ketto3InfoHansyokuNum1.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
# InputDataSet New Levels: Horse.Ketto3InfoHansyokuNum2
# ---------------------------------------------------------------------------------------------------------------------------
print(paste0("levels(data$Horse.Ketto3InfoHansyokuNum2)=", levels(data$Horse.Ketto3InfoHansyokuNum2)))
print(paste0("levels(InputDataSet$Horse.Ketto3InfoHansyokuNum2)=", levels(InputDataSet$Horse.Ketto3InfoHansyokuNum2)))
Horse.Ketto3InfoHansyokuNum2.Index <- which(!(InputDataSet$Horse.Ketto3InfoHansyokuNum2 %in% levels(data$Horse.Ketto3InfoHansyokuNum2)))
print(paste0("length(Horse.Ketto3InfoHansyokuNum2.Index)=", length(Horse.Ketto3InfoHansyokuNum2.Index)))
InputDataSet$Horse.Ketto3InfoHansyokuNum2[Horse.Ketto3InfoHansyokuNum2.Index] <- NA
# ---------------------------------------------------------------------------------------------------------------------------
...
# print(analyze.results.step.summary)
# print("analyze.results.step_aov=")
# print(analyze.results.step_aov)
# print("analyze.results.step_vif=")
# print(analyze.results.step_vif)

# OutputDataSet$PredictValue <- predict(analyze.results.step, newdata=InputDataSet, na.action=na.omit, allow.new.levels=TRUE)
...
# print(paste0("analyzeFunc=", analyzeFunc))
# print("analyze.resultser=")
# print(analyze.resultser)
# print("analyze.resultser.fixef=")
# print(analyze.resultser.fixef)
# print("analyze.resultser_ranef=")
# print(analyze.resultser_ranef)
# print("analyze.resultser.summary=")
# print(analyze.resultser.summary)
# print("analyze.resultser_vif =)
# print(analyze.resultser_vif)

# OutputDataSet$PredictValue <- predict(analyze.resultser, newdata=InputDataSet, na.action=na.omit, allow.new.levels=TRUE)
# na.action={na.omit, na.fail, na.exclude, na.pass}
...
print(paste0("analyzeFunc=", analyzeFunc))
	...
	{
	# PredictDataSet <- data.frame(rxPredict(analyze.results.step, data = InputDataSet, writeModelVars = FALSE))
	# PredictDataSet <- data.frame(predict(analyze.results.step, data = InputDataSet))
	# PredictDataSet$PredictValue <- predict(analyze.results.step, newdata = InputDataSet, na.action = na.omit, allow.new.levels = TRUE)
	predictData <- predict(analyze.results.step, newdata = InputDataSet, na.action = na.omit, allow.new.levels = TRUE)
	
	PredictDataSet <- data.frame(predictData)	
	}
