...
# analyze.results.step <- Step(analyze.results, d rection = "both", trace = 0)
# analyze.results.step <- stepAIC(analyze.results,d irection = "both", trace = 0)
...
analyze.results.step.varsel <- rxStepControl(method = "stepwise", scope = formula, keepStepCoefs = TRUE)

analyze.results.step <- rxLogit(formula,
, data = data
, variableSelection = analyze.results.step.varsel
)

# analyze.results.step <- rxGlm(form,
# , data = data
...
# print("--------------------------------------------------------------------------------")
# analyze.results.step.aic <- stepAIC(analyze.results.step)
# print(paste0("stepAIC(analyze.results.step)=", analyze.results.step.aic))
# print("--------------------------------------------------------------------------------")
