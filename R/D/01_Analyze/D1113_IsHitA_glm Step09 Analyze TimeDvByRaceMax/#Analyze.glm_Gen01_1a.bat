...
REM ECHO ********** Type21 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 1
REM ECHO ********** Type22 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 2
REM ECHO ********** Type23 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 3
REM ECHO ********** Type24 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 4
REM ECHO ********** Type25 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 5
REM ECHO ********** Type26 **********
REM Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 6
REM ECHO ********** Type31 **********
