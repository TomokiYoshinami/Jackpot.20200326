print(paste0(Sys.time(),  " --- source_logic_lmer.R Start ---"))

jackpot_results_lmer <- lmer(

AnalyzeExpectedValueF01Gen02.ExpectedValue

~

+ 1

+ AnalyzeExpectedValueF01Gen02.PrevExpectedValue + (AnalyzeExpectedValueF01Gen02.PrevExpectedValue|AnalyzeExpectedValueF01Gen02.HansyokuNum)
+ AnalyzeExpectedValueF01Gen02.PrevHitRateA + (AnalyzeExpectedValueF01Gen02.PrevHitRateA|AnalyzeExpectedValueF01Gen02.HansyokuNum)
...
print(paste0(Sys.time(),  " --- source_logic_lmer.R Finished ---"))
