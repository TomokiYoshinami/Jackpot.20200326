...
# analyze.results.glmer <- glm(form,
# , data = data
# ,family = "gaussian"
# ,family = "binomial"
# ,family = "poisson"
...
# analyze.results.glmer.step <- Step(analyze.results.glmer, d rection = "both", trace = 0)
# analyze.results.glmer.step <- stepAIC(analyze.results.glmer,d irection = "both", trace = 0)
# analyze.results.glmer.step.summary <- summary(analyze.results.glmer.step)
# print("analyze.results.glmer.step.summary")
# print(analyze.results.glmer.step.summary)
...
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
print(paste0(Sys.time(), " --- rxLogit Start ---"))
source(paste0("source_logic", "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, ".R"), echo = FALSE, max.deparse.length = Inf)

# analyze.results.glmer.step.varsel <- rxStepControl(method = "stepwise", scope = form, keepStepCoefs = TRUE)

# analyze.results.glmer.step <- rxLinMod(form,
analyze.results.glmer.step <- rxLogit(form,
, data = data
# , variableSelection = analyze.results.glmer.step.varsel
)
...
# analyze.results.glmer.step <- rxGlm(form,
# , data = data
...
print("--------------------------------------------------------------------------------")
print("analyze.results.glmer.step=")
print(analyze.results.glmer.step)
analyze.results.glmer.step.summary <- summary(analyze.results.glmer.step)
print("--------------------------------------------------------------------------------")
print("--------------------------------------------------------------------------------")
...
print(analyze.results.glmer.step.summary)
print("--------------------------------------------------------------------------------")
print(paste0(Sys.time(), " --- rxLogit Finish ---"))
# ---------------------------------------------------------------------------------------------------------------------------
# rxSummary
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
# print(paste0(Sys.time(), " --- rxSummary Start ---"))
# rxSummary1 <- rxSummary(
       # formula = ~ Gen01.HitRate1, data = inDataSource
       # )
# print("rxSummary1=")
# print(rxSummary1)

# rxSummary2 <- rxSummary(
       # formula =  ~ Gen01.HansyokuNum, data = inDataSource
       # )
# print("rxSummary2=")
# print(rxSummary2)

# rxSummary3 <- rxSummary(
       # formula = RaceHorse.IsHitA ~ Gen01.HansyokuNum, data = inDataSource
       # )
# print("rxSummary3=")
# print(rxSummary3)

# print(paste0(Sys.time(), " --- rxSummary Finish ---"))
# toc()
...
# print("rxStepPlot=")
# rxStepPlot(analyze.results.glmer.step)
...
## Not run:
# analyze.results.glmer.anova_type1 <- anova(analyze.results.glmer, type = 1)
# print(paste0("analyze.results.glmer.anova_type1=", analyze.results.glmer.anova_type1))
# analyze.results.glmer.anova_type2 <- anova(analyze.results.glmer, type = 2)
# print(paste0("analyze.results.glmer.anova_type2=", analyze.results.glmer.anova_type2))
# analyze.results.glmer.anova_type3 <- anova(analyze.results.glmer, type = 3)
# print(paste0("analyze.results.glmer.anova_type3=", analyze.results.glmer.anova_type3))
# AOV
# analyze.results.glmer.step.aov <- aov(analyze.results.glmer.step)
# print("analyze.results.glmer.step.aov=")
# analyze.results.glmer.step.aov
# Confint
# analyze.results.glmer.step.confint <- confint(analyze.results.glmer.step)
# print("analyze.results.glmer.step.confint=")
# analyze.results.glmer.step.confint
# vif
# analyze.results.glmer.step.vif <- vif(analyze.results.glmer.step)
# print("analyze.results.glmer.step.vif=")
# analyze.results.glmer.step.vif
# p-value
...
# Collinearity
# analyze.results.glmer.step.collinearity <- check_collinearity(analyze.results.glmer.step.summary)
# print("analyze.results.glmer.step.collinearity=")
# analyze.results.glmer.step.collinearity
# Zero Inflation
# analyze.results.glmer.step.check_zeroinflation <- check_zeroinflation(analyze.results.glmer.step.summary)
# print("analyze.results.glmer.step.check_zeroinflation=")
# analyze.results.glmer.step.check_zeroinflation
# toc()
# ---------------------------------------------------------------------------------------------------------------------------
# plot glm
# ---------------------------------------------------------------------------------------------------------------------------
...
# pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
# par(ps = 9) # Font Size
# plot(analyze.results.glmer, main = "analyze.results.glmer", col = "magenta")
# dev.off()
# toc()
# ---------------------------------------------------------------------------------------------------------------------------
# plot step
# ---------------------------------------------------------------------------------------------------------------------------
# tic()
# graphType <- "plot.analyze.results.glmer.step"
# pdfFilename <- paste(paste0(fileNamePrefixPdf, "_", analyzeCategory, "_", analyzeFunc, "_", analyzeType, "_Type", analyzeTrackTypeCd, analyzeJyokenCd, "_", graphType, constColon, constFileExtensionPdf))
# print(paste0("pdfFilename=", pdfFilename))
# pdf(pdfFilename, paper = "a4r", width = 9.5, height = 7, pointsize = 9)
# par(ps = 9) # Font Size
# plot(analyze.results.glmer.step, main = "analyze.results.glmer.step", col = "magenta")
# dev.off()
# toc()
# ---------------------------------------------------------------------------------------------------------------------------
# Save Image
