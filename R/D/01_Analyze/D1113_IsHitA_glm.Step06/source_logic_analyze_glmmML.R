print(paste0(Sys.time(),  " --- source_logic_glmmML.R Start ---"))

anayze.results.glm <- glmmML(
...
+ Race.SyussoTosu + (1 | Race.RaceType1Cd) + (0 + Race.SyussoTosu | Race.RaceType1Cd)
...
,offset = log(RaceHorse.SyussoTosu)
...
print(paste0(Sys.time(),  " --- source_logic_glmmML.R Finished ---"))
