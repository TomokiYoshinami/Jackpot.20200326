...
##########################################################################################
print(paste0(Sys.time(),  " --- analyze_glm.2.R Start ---"))
# ---------------------------------------------------------------------------------------------------------------------------
# Parameter
# ---------------------------------------------------------------------------------------------------------------------------
...
##########################################################################################
source(paste0("source_transform.", sqlViewName2, ".2.R"), echo=FALSE, max.deparse.length=Inf) # source(sourceFilename, echo=TRUE, max.deparse.length=Inf)
#########################################################################################
data.after < -nrow(data)
data.diff <- data.before-data.after
...
source(paste0("source_logic_", funcName, ".2.R"), echo=FALSE, max.deparse.length=Inf) # source(sourceFilename, echo=TRUE, max.deparse.length=Inf)
...
print("q...")
 ...
 print(paste0(Sys.time(),  " --- analyze_glm.2.R Finished ---"))
