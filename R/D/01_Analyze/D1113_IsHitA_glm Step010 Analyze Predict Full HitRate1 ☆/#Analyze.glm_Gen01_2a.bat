...
ECHO ********** Type23 **********
Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 3
ECHO ********** Type24 **********
Rscript --slave --vanilla --encoding=utf-8 script.R D1113 analyze Gen01 IsHitA glm 2 4
REM ECHO ********** Type25 **********
